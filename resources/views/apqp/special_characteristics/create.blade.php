...
@section('content')
  ...
  @endif
    <div class="card">
        ...
        <div class="card-body">
            <div class="col-md-12">
                <form id="category_save" method="POST"  enctype="multipart/form-data" action="{{route('special_characteristics.store')}}">
                  @csrf
                  @method('POST')
                    <div class="row mb-3">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-12">
                            <table class="table table-responsive table-bordered" id="tab_logic">
                                ...
                                <tr id='addr0'>
                                    ...
                                    <td><input type="text" class="form-control" name="instrument[]"></td>
