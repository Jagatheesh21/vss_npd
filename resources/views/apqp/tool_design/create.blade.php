                        ...
                        <div class="col-md-12">
                            <table class="table table-responsive table-bordered" id="tab_logic">
                                ...
                                <tr>
                                    ...
                                    <th>Tool Material Gauge</th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr id='addr0'>
                                    <td>1</td>
                                    <td><input type="text" class="form-control" name="tooling_list[]">
                                    </td>
                                    <td><input type="text" class="form-control" name="tool_life[]"></td>
                                    <td><input type="text" class="form-control" name="toll_frequency[]"></td>
                                    <td><input type="text" class="form-control" name="tool_material_gauge[]"></td>
                                </tr>
                                <tr id='addr1'></tr>
                                </tbody>
                            </table>
