...
@section('content')
  ...
  @endif
    <div class="card">
        ...
        <div class="card-body">
            <div class="col-md-12">
                <form id="category_save" method="POST" enctype="multipart/form-data" action="{{route('product_information_data.store')}}">
                  @csrf
                  @method('POST')
                    <div class="row mb-3">
                        <div class="col-md-3 ">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="price" class="form-control" onpaste="return false;" onkeypress=" return isNumber(event)">
                            @error('price')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                        <div class="col-md-3">
                            ...
                            <input type="text" name="volume_requirements" class="form-control" >
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="special_characteristics" id="inlineRadio1" value="YES" checked>
                                <label class="form-check-label" for="inlineRadio1">YES</label>
                              </div>
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="special_characteristics" id="inlineRadio2" value="NO">
                                <label class="form-check-label" for="inlineRadio2">NO</label>
                              </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="cpk_ppk_requirements" id="inlineRadio1" value="YES" checked>
                                <label class="form-check-label" for="inlineRadio1">YES</label>
                              </div>
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="cpk_ppk_requirements" id="inlineRadio2" value="NO">
                                <label class="form-check-label" for="inlineRadio2">NO</label>
                              </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="customer_requirements" id="inlineRadio1" value="YES" checked>
                                <label class="form-check-label" for="inlineRadio1">YES</label>
                              </div>
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="customer_requirements" id="inlineRadio2" value="NO">
                                <label class="form-check-label" for="inlineRadio2">NO</label>
                              </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="list_of_new_equipments" id="inlineRadio1" value="YES" checked>
                                <label class="form-check-label" for="inlineRadio1">YES</label>
                              </div>
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="list_of_new_equipments" id="inlineRadio2" value="NO">
                                <label class="form-check-label" for="inlineRadio2">NO</label>
                              </div>
                            @error('product_description')
                            <span class="text-danger">{{$message}}</span>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="part_approval_requirement" id="inlineRadio1" value="YES" checked>
                                <label class="form-check-label" for="inlineRadio1">YES</label>
                              </div>
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="part_approval_requirement" id="inlineRadio2" value="NO">
                                <label class="form-check-label" for="inlineRadio2">NO</label>
                              </div>
                            @error('product_description')
                            <span class="text-danger">{{$message}}</span>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="proto_type_build_requirement" id="inlineRadio1" value="YES" checked>
                                <label class="form-check-label" for="inlineRadio1">YES</label>
                              </div>
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="proto_type_build_requirement" id="inlineRadio2" value="NO">
                                <label class="form-check-label" for="inlineRadio2">NO</label>
                              </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="labeling_requirement" id="inlineRadio1" value="YES" checked>
                                <label class="form-check-label" for="inlineRadio1">YES</label>
                              </div>
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="labeling_requirement" id="inlineRadio2" value="NO">
                                <label class="form-check-label" for="inlineRadio2">NO</label>
                              </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="product_traceability_requirement" id="inlineRadio1" value="YES" checked>
                                <label class="form-check-label" for="inlineRadio1">YES</label>
                              </div>
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="product_traceability_requirement" id="inlineRadio2" value="NO">
                                <label class="form-check-label" for="inlineRadio2">NO</label>
                              </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="other_requirement" id="inlineRadio1" value="YES" checked>
                                <label class="form-check-label" for="inlineRadio1">YES</label>
                              </div>
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="other_requirement" id="inlineRadio2" value="NO">
                                <label class="form-check-label" for="inlineRadio2">NO</label>
                              </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="experience_of_previous_developement" id="inlineRadio1" value="YES" checked>
                                <label class="form-check-label" for="inlineRadio1">YES</label>
                              </div>
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="experience_of_previous_developement" id="inlineRadio2" value="NO">
                                <label class="form-check-label" for="inlineRadio2">NO</label>
                              </div>
                            @error('proto_type_build_requirement')
                            <span class="text-danger">{{$message}}</span>
                        ...
                        <div class="col-md-3">
                            ...
                            <textarea name="details_of_brought_out_part" id="details_of_brought_out_part" class="form-control" rows="5"></textarea>
                        ...
                        <div class="col-md-3">
                            ...
                            <textarea name="details_of_subcontract_process" id="details_of_subcontract_process" class="form-control" rows="5"></textarea>
                    ...
                    <button type="submit" id="submit" class="btn btn-primary mt-3" onclick="confirm('Are you sure?')">Save</button>
                  </form>
            </div>
        </div>
    </div>
