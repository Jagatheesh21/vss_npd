                  ...
                  @method('POST')
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <a href="{{url($location)}}/{{$sir_sample_approval_data[0]->file}}" class="form-control btn btn-success btn-sm text-white" target="_blank">Download</a>
                            @error('file')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <textarea name="remarks" class="form-control bg-light" id="remarks" cols="30" rows="5" readonly required>{{$sir_sample_approval_data[0]->remarks}}</textarea>
                        </div>
                    </div>
                  </form>
            </div>
