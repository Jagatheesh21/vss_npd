                  ...
                  @method('POST')
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" id="model_reference" name="model_reference" class="form-control bg-light" value="{{$prelaunch_control_plan_data[0]->supplier_plant_approval_date}}" readonly>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="date" id="supplier_plant_approval_date" name="supplier_plant_approval_date" class="form-control bg-light" value="{{$prelaunch_control_plan_data[0]->supplier_plant_approval_date}}" readonly>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="date" id="customer_engineer_approval_date" name="customer_engineer_approval_date" class="form-control bg-light" value="{{$prelaunch_control_plan_data[0]->customer_engineer_approval_date}}" readonly>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="date" id="other_approval_date" name="other_approval_date" class="form-control bg-light" value="{{$prelaunch_control_plan_data[0]->other_approval_date}}" readonly>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" id="material_specification_norms" name="material_specification_norms" class="form-control bg-light" value="{{$prelaunch_control_plan_data[0]->material_specification_norms}}" readonly required>
                        ...
                        <div class="col-md-3">
                            ...
                            <a href="{{url($location)}}/{{$prelaunch_control_plan_data[0]->file}}" class="form-control btn btn-success btn-sm text-white" target="_blank">Download</a>
                            @error('file')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                        <div class="col-md-3">
                            ...
                            <textarea name="remarks" class="form-control bg-light" id="remarks" cols="30" rows="5" readonly required>{{$prelaunch_control_plan_data[0]->remarks}}</textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12" style="overflow-x: auto">
                            <table class="table table-bordered text-center" id="tab_logic">
                                ...
                                <tbody class="col-md-12">
                                    @forelse ($prelaunch_control_plan_data as $prelaunch_control_plan)
                                    <tr>
                                        <td>{{$loop->iteration}}</td>
                                        <td><div class="form-group">
                                            <div style="width:200px">
                                                <input type="text" class="form-control bg-light" name="process_seq_no[]" value="{{$prelaunch_control_plan->process_seq_no}}" readonly>
                                                </div>
                                            </div>
                                        </td>
                                        <td><div class="form-group">
                                                <div style="width:200px">
                                                    <input type="text" class="form-control bg-light" name="tools_for_manufacturing[]" value="{{$prelaunch_control_plan->tools_for_manufacturing}}" readonly>
                                                </div>
                                            </div>
                                        </td>
                                        <td><div class="form-group">
                                                <div style="width:200px">
                                                    <input type="text" class="form-control bg-light" name="s_no[]" value="{{$prelaunch_control_plan->s_no}}" readonly>
                                                </div>
                                            </div>
                                        </td>
                                        <td><div class="form-group">
                                                <div style="width:200px">
                                                    <textarea name="product[]" class="form-control bg-light" cols="30" rows="5" readonly>{{$prelaunch_control_plan->product}}</textarea>
                                                </div>
                                            </div>
                                        </td>
                                        <td><div class="form-group">
                                                <div style="width:200px">
                                                    <input type="text" class="form-control bg-light" name="material_grade[]" value="{{$prelaunch_control_plan->material_grade}}" readonly>
                                                </div>
                                            </div>
                                        </td>
                                        <td><div class="form-group">
                                                <div style="width:200px">
                                                    <input type="text" class="form-control bg-light" name="special_character[]" value="{{$prelaunch_control_plan->special_character}}" readonly>
                                                </div>
                                            </div>
                                        </td>
                                        <td><div class="form-group">
                                            <div style="width:200px">
                                                <textarea  name="process_specification[]" cols="30" rows="5" class="form-control bg-light" readonly>{{$prelaunch_control_plan->process_specification}}</textarea>
                                            </div>
                                        </div>
                                    </td>
                                        <td><div class="form-group">
                                                <div style="width:200px">
                                                    <textarea  name="measurement_technique[]" cols="30" rows="5" class="form-control bg-light" readonly>{{$prelaunch_control_plan->measurement_technique}}</textarea>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <div style="width:200px">
                                                    <input type="text" name="size[]" class="form-control bg-light" value="{{$prelaunch_control_plan->size}}" readonly>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <div style="width:200px">
                                                    <input type="text" name="frequency[]" class="form-control bg-light" value="{{$prelaunch_control_plan->frequency}}" readonly>
                                                </div>
                                            </div>
                                        </td>
                                        <td><div class="form-group">
                                                <div style="width:200px">
                                                    <textarea name="control_method[]" id="" cols="30" rows="5" class="form-control bg-light" readonly>{{$prelaunch_control_plan->control_method}}</textarea>
                                                </div>
                                            </div>
                                        </td>
                                        <td><div class="form-group">
                                                <div style="width:200px">
                                                    <textarea name="responsiblity[]" id="" cols="30" rows="5" class="form-control bg-light" readonly>{{$prelaunch_control_plan->responsiblity}}</textarea>
                                                </div>
                                            </div>
                                        </td>
                                        <td><div class="form-group">
                                                <div style="width:200px">
                                                    <textarea name="reaction_plan[]" id="" cols="30" rows="5" class="form-control bg-light" readonly>{{$prelaunch_control_plan->reaction_plan}}</textarea>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
