  ...
  @endif
    <div class="card">
        <div class="card-header text-center">
            <b>Experience Sharing (TGW)</b>
        </div>
        <div class="card-body">
            <div class="col-md-12">
                <form id="category_save" method="POST" action="{{route('experience_sharing.store')}}">
                  @csrf
                  @method('POST')
                    <div class="row mb-3">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-12" style="overflow-x: auto">
                            <table class="table table-responsive table-bordered text-center" id="tab_logic">
                                ...
                                <tr>
                                    ...
                                    <th rowspan="2">Part Family</th>
                                    <th rowspan="2">Defect</th>
                                    <th rowspan="2">Root Cause</th>
                                    <th rowspan="2">Corrective Action</th>
                                    <th rowspan="2">New Defect Or Old</th>
                                    <th rowspan="2">PFMEA to be Update or NOT</th>
                                    <th colspan="3">Whether PFMEA Updated</th>
                                    <th rowspan="2">Similar HD Status</th>
                                ...
                                <tr id='addr0'>
                                    ...
                                    <td>
                                        <div style="width:200px">
                                            <input type="text" class="form-control" name="part_family[]"></td>
                                        </div>
                                    <td>
                                        <div style="width:200px">
                                            <textarea name="defect[]" class="form-control" cols="30" rows="5"></textarea>
                                        </div>
                                    </td>
                                    <td>
                                        <div style="width:200px">
                                            <textarea name="root_cause[]" class="form-control" cols="30" rows="5"></textarea>
                                        </div>
                                    </td>
                                    <td>
                                        <div style="width:200px">
                                            <textarea name="corrective_action[]" class="form-control" cols="30" rows="5"></textarea>
                                        </div>
                                    </td>
                                    <td>
                                        <div style="width:200px">
                                            <textarea name="new_defect_or_old[]" class="form-control" cols="30" rows="5"></textarea>
                                        </div>
                                    </td>
                                    <td>
                                        <div style="width:200px">
                                            <textarea name="PFEMA_to_be_update_or_not[]" class="form-control" cols="30" rows="5"></textarea>
                                        </div>
                                    </td>
                                    <td>
                                        <div style="width:200px">
                                            <textarea name="reference_number[]" class="form-control" cols="30" rows="5"></textarea>
                                        </div>
                                    </td>
                                    <td>
                                        <div style="width:200px">
                                            <textarea name="rev_no[]" class="form-control" cols="30" rows="5"></textarea>
                                        </div>
                                    </td>
                                    <td>
