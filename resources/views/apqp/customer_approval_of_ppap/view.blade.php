  ...
  @endif
    <div class="card">
        <div class="card-header text-center">
            <b>Customer Approval Of PPAP</b>
        </div>
        <div class="card-body">
            <div class="col-md-12">
                <form id="quote_save" method="POST" enctype="multipart/form-data" action="{{route('customer_approval_of_ppap.store')}}" >
                  @csrf
                  @method('POST')
                    <div class="row mb-3">
                        <input type="hidden" name="stage_id" value="4">
                        <input type="hidden" name="sub_stage_id" value="27">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <a href="{{url($location)}}/{{$customer_approval_of_ppap_data[0]->file}}" class="form-control btn btn-success btn-sm text-white" target="_blank">Download</a>
                            @error('file')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <textarea name="remarks" class="form-control bg-light" id="remarks" cols="30" rows="5" readonly required>{{$customer_approval_of_ppap_data[0]->remarks}}</textarea>
                        </div>
                    </div>
