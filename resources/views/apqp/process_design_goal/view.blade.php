...
@section('content')
  ...
  @endif
    <div class="card">
        ...
        <div class="card-body">
            <div class="col-md-12">
                <form id="category_save" method="POST" action="{{route('process_design_goal.store')}}">
                  @csrf
                  @method('POST')
                    <div class="row mb-3">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <a href="{{url($location)}}/{{$process_design_goal_data[0]->file}}" class="form-control btn btn-success btn-sm text-white" target="_blank">Download</a>
                            @error('file')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                        <div class="col-md-3">
                            ...
                            <textarea name="remarks" class="form-control bg-light" id="remarks" cols="30" rows="5" readonly required>{{$process_design_goal_data[0]->remarks}}</textarea>
                        </div>
                    </div>
                    <div class="row clearfix">
                        <div class="col-md-12" style="overflow-x:auto">
                            <table class="table table-responsive table-bordered text-center" id="tab_logic">
                                ...
                                <tbody>
                                    @forelse ($process_design_goal_data as $process_design_goal)

                                <tr>
                                    <td>{{$loop->iteration}}</td>
                                    <td>
                                        <div style="width:200px;">
                                            <textarea name="process_description[]" class="form-control bg-light" readonly cols="30" rows="5">{{$process_design_goal->product_description}}</textarea>
                                        </div>
                                    </td>
                                    <td>
                                        <div style="width:150px;">
                                        <input type="text" name="target_cost[]" class="form-control bg-light" readonly value="{{$process_design_goal->target_cost}}">
                                        </div>
                                    </td>
                                    <td>
                                        <div style="width:200px;">
                                        <input type="text" name="target_quality[]" class="form-control bg-light" readonly value="{{$process_design_goal->target_quality}}">
                                        </div>
                                    </td>
                                    <td>
                                        <div style="width:200px;">
                                        <input type="text" name="target_output[]" class="form-control bg-light" readonly value="{{$process_design_goal->target_output}}">
                                        </div>
                                    </td>
                                    <td>
                                        <div style="width:200px;">
                                        <input type="text" name="target_cpk[]" class="form-control bg-light" readonly value="{{$process_design_goal->target_cpk}}">
                                        </div>
                                    </td>
                                    <td>
                                        <div style="width:200px;">
                                        <input type="text" name="actual_cost[]" class="form-control bg-light" readonly value="{{$process_design_goal->actual_cost}}">
                                        </div>
                                    </td>
                                    <td>
                                        <div style="width:200px;">
                                        <input type="text" name="actual_quality[]" class="form-control bg-light" readonly value="{{$process_design_goal->actual_quality}}">
                                        </div>
                                    </td>
                                    <td>
                                        <div style="width:200px;">
                                        <input type="text" name="actual_output[]" class="form-control bg-light" readonly value="{{$process_design_goal->actual_output}}">
                                        </div>
                                    </td>
                                    <td>
                                        <div style="width:200px;">
                                        <input type="text" name="actual_cpk[]" class="form-control bg-light" readonly value="{{$process_design_goal->actual_cpk}}">
                                        </div>
                                    </td>
                                </tr>
                                @empty
