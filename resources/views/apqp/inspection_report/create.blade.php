  ...
  @endif
    <div class="card">
        <div class="card-header text-center">
            <b>Tool Inspection Report</b>
        </div>
        <div class="card-body">
            <div class="col-md-12">
                <form id="category_save" method="POST" action="{{route('tool_design.store')}}">
                  @csrf
                  @method('POST')
                    <div class="row mb-3">
                        <div class="col-md-3">
                    ...
                    <div class="row clearfix">
                        <div class="col-md-12">
                            <table class="table table-responsive table-bordered" id="tab_logic">
                                ...
                                <tr id='addr0'>
                                    <td>1</td>
                                    <td><input type="text" class="form-control" name="characteristics[]">
                                    </td>
                                    <td><input type="text" class="form-control" name="specification[]">
                                    </td>
                                    <td><input type="text" class="form-control" name="method_of_checking[]"></td>
                                    ...
                                    <td><input type="text" class="form-control" name="5[]"></td>
