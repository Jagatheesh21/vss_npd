                  ...
                  <input type="hidden" name="sub_stage_id" value="4">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-3">
                            ...
                            <textarea name="remarks" class="form-control bg-light" id="remarks" cols="30" rows="5" readonly required>{{$risk_analysis_data[0]->remarks}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="row clearfix mt-3">
                        <div class="col-md-12">
                            <table class="table table-responsive table-bordered" id="tab_logic">
                                ...
                                <tbody>
                                    @forelse ($risk_analysis_data as $risk_analysis)
                                    <tr>
                                        <td>{{$loop->iteration}}</td>
                                        <td><input type="text" class="form-control bg-light" name="type[]" value="{{$risk_analysis->type}}" readonly></td>
                                        <td><input type="text" class="form-control bg-light" name="risks[]" value="{{$risk_analysis->risks}}"></td>
                                        <td><input type="text" class="form-control bg-light" name="risk_involved[]" value="{{$risk_analysis->risk_involved}}"></td>
                                        <td><input type="text" class="form-control bg-light" name="risk_level[]" value="{{$risk_analysis->risk_level}}"></td>
                                        <td><input type="text" class="form-control bg-light" name="high_risk[]" value="{{$risk_analysis->high_risk}}"></td>
                                    </tr>
                                    @empty
                                    <tr>
