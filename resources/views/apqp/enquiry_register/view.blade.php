        ...
        <div class="col-md-12">
            <form id="category_save" method="POST" action="{{route('save_register')}}" enctype="multipart/form-data">
              ...
              <div class="col-md-4">
                ...
                <input type="date" name="received_date" id="received_date" class="form-control @error('received_date') is-invalid @enderror bg-light" readonly value="{{ $model->received_date }}">
                @error('received_date')
                <span class="text-danger">{{$message}}</span>
                @enderror
              </div>
              <div class="col-md-4">
                ...
                <input type="text" name="average_annum_demand" id="average_annum_demand" readonly class="form-control @error('average_annum_demand') is-invalid @enderror bg-light" value="{{ $model->average_annum_demand }}">
              ...
              <div class="col-md-4">
                ...
                <br>
                <a href="{{url($model->timing_plan->apqp_timing_plan_number.'/enquiry_register/'.$model->enquiry_document)}}" target="_blank" class="btn btn-sm btn-success text-white">Download</a>
              </div>
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="ern_sample" id="inlineRadio1" value="YES" @if($model->ern_sample=='YES') checked @endif readonly >
                        <label class="form-check-label" for="inlineRadio1">YES</label>
                      </div>
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="ern_sample" id="inlineRadio2" value="NO" @if($model->ern_sample=='NO') checked @endif>
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="sir_sample" id="inlineRadio3" value="YES" @if($model->sir_sample=='YES') checked @endif readonly >
                        <label class="form-check-label" for="inlineRadio1">YES</label>
                      </div>
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="sir_sample" id="inlineRadio4" value="NO" @if($model->sir_sample=='NO') checked @endif readonly >
                        <label class="form-check-label" for="inlineRadio2">NO</label>
                      </div>
                    @error('sir_sample')
                    <span class="text-danger">{{$message}}</span>
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="safe_launch_sample" id="inlineRadio5" value="YES"  @if($model->safe_launch_sample=='YES') checked @endif  readonly>
                        <label class="form-check-label" for="inlineRadio1">YES</label>
                      </div>
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="safe_launch_sample" id="inlineRadio6" value="NO" @if($model->safe_launch_sample=='NO') checked @endif readonly>
                        <label class="form-check-label" for="inlineRadio2">NO</label>
                      </div>
                    @error('ern_sample')
                    <span class="text-danger">{{$message}}</span>
