                            ...
                            <table class="table table-responsive table-bordered" id="tab_logic">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="date" name="target_date[]" readonly class="form-control bg-light" value="{{ $review_sub_stage->plan_end_date }}">
                                        </td>
                                        <td>
                                            <input type="date" name="actual_date[]" readonly class="form-control bg-light" value="{{ $review_sub_stage->actual_end_date }}">
                                        </td>
                                        <td>
                                            <div style="width:200px;">
                                                <textarea name="delay_reason[]" class="form-control" cols="30" rows="5"></textarea>
                                            </div>
                                        </td>
                                        <td>
                                            <div style="width:200px">
                                                <textarea name="action_plan[]" class="form-control" cols="30" rows="5"></textarea>
                                            </div>
                                        </td>
                                        <td>
                                            <input type="date" name="revisied_target_date[]" class="form-control">
                                        </td>
                                        <td>
                                            <div style="width:200px">
                                                <textarea name="review_comments[]" class="form-control" cols="30" rows="5"></textarea>
                                            </div>
                                        </td>
