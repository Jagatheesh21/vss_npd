...
<div class="card">
    <div class="card-header">
        <strong>SubStage List</strong>  <a href="{{route('sub_stage.create')}}" class="btn btn-sm btn-primary float-end">Add New</a>
    </div>
    <div class="card-body">
...
<script>
        ...
        processing: true,
        serverSide: true,
        ajax: "{{ route('sub_stage.index') }}",
        columns: [
            {data: 'DT_RowIndex', name: 'DT_RowIndex'},
            {data: 'stage.name', name: 'name'},
